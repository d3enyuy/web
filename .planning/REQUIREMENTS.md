...
- [x] **CONT-04**: Replace hardcoded blog data in homepage blog section with dynamic content from markdown files
- [x] **CONT-05**: Link homepage blog cards to `/blog/[slug]` routes
